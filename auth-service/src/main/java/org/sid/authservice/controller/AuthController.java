...
//
//import org.sid.authservice.dto.AuthRequest;
//import org.sid.authservice.dto.AuthResponse;
////import org.sid.authservice.model.User;
////import org.sid.authservice.service.AuthService;
////import org.sid.authservice.service.JwtService;
//import org.sid.authservice.service.KeycloakService;
...
//        System.out.println("=== REQUÊTE LOGIN REÇUE (MODE MOCK) ===");
//        System.out.println("Username: " + request.getUsername());
//
//        // Vérification basique des identifiants (pour le développement uniquement)
//        if ("hamza".equals(request.getUsername()) && "test123".equals(request.getPassword())) {
//            // Création d'un token JWT mock (pour le développement uniquement)
...
//
//            System.out.println("=== AUTHENTIFICATION RÉUSSIE (MODE MOCK) ===");
//            System.out.println("Token mock généré pour: " + request.getUsername());
//
//            return ResponseEntity.ok(new AuthResponse(mockToken));
//        } else {
//            System.out.println("=== ÉCHEC D'AUTHENTIFICATION (MODE MOCK) ===");
//            System.out.println("Identifiants incorrects");
//
//            return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
//                    .body("Identifiants incorrects. Utilisez 'hamza' et 'test123' pour le développement.");
//        }
//    }
//
//    @GetMapping("/validate")
